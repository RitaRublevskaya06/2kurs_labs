...
// Определяем класс my_stack_SHORT, который наследует стандартный стек для работы с короткими целыми числами
...
// Макрос для записи информации о текущем шаге и правиле
...
// Макрос для записи информации о текущем шаге без указания правила
...
// Макрос для записи информации о шаге с увеличением счетчика
...
namespace MFST
{
	...
	struct Mfst							//магазинный автомат
	{
		...
		// Структура для хранения информации о дедукции
		struct Deducation
		{
			short size;
			short* nrules;
