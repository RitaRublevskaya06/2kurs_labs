...
namespace DAL_Celebrity_MSSQL
{
    ...
    public class Init
    {
        private static string connString = @"Server=LENOVO-HOME\SQLEXPESS1;Database=LifeEventsOfCelebrities;Trusted_Connection=True;User Id=sa;Password=sa;TrustServerCertificate=True;";
