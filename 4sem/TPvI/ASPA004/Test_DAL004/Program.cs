...
using (IRepository repository = Repository.Create("Celebrities"))
{
    ...
    if (testupd1 != null)
    {
        var updateResult = repository.updCelebrityById((int)testupd1, new Celebrity(0, "Updated1", "Updated1", "Photo/Updated1.jpg"));
    ...
    if (testupd2 != null)
    {
        var updateResult = repository.updCelebrityById((int)testupd2, new Celebrity(0, "Updated2", "Updated2", "Photo/Updated2.jpg"));
        if (updateResult != null)
    ...
    var updateResult1000 = repository.updCelebrityById(1000, new Celebrity(0, "Updated1000", "Updated1000", "Photo/Updated1000.jpg"));
    if (updateResult1000 != null)
